  ...
  <div class="container mt-5">
    ...
    <form method="POST">
      <div class="form-row">
        ...
        <div class="form-group col-md-2">
          <label for="start_date">Borrow Date</label>
 ...
 <?php
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  if (!empty($borrow_date)) {
          $sql .= " AND `borrowed_at` = '$borrow_date'";
      }
	  if (!empty($due_date)) {
      ...
      echo '<thead><tr><th>User ID</th><th>Book ID</th><th>Book Category</th><th>Borrowed Date</th><th>Returned Date</th><th>Due Date</th><th>Status</th></tr></thead>';
      echo '<tbody>';
